  ...
  return (
    <section id="about" className="relative overflow-hidden py-16 lg:py-20">
      ...
      <div className="grid gap-10 px-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-start lg:gap-16 lg:px-16 xl:px-24 2xl:px-32">
        {/* Left: text content — order-2 on mobile so headshot comes first */}
        <motion.div
        ...
        >
          ...
          <div className="mt-6 space-y-4 text-base leading-relaxed text-bloom-brown-light">
            <p>
              ...
              practicing in Hyde Park, Chicago and Frankfort, IL. She is committed to offering
              compassionate, whole-person care rooted in trauma-informed practices. She earned
              her BA in Women's Studies and Psychology from Goucher College, where she co-led a
              sexual and reproductive health education club and contributed to sexual assault
              survey research.
            </p>
            <p>
